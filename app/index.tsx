...
export default function App() {
  ...
  useEffect(() => {
    async function prepare() {
      ...
      const blazeposeModelConfig: posedetection.BlazePoseTfjsModelConfig = {
        runtime: 'tfjs',
      }; 
 ...
 /*      if (LOAD_MODEL_FROM_BUNDLE) {
        ...
        const modelWeights1 = require('../app/offline_model/group1-shard1of2.bin');
        const modelWeights2 = require('../app/offline_model/group1-shard2of2.bin');
        blazeposeModelConfig.detectorModelUrl = bundleResourceIO(modelJson, [
          modelWeights1,
          modelWeights2,
        ]);
      } */
